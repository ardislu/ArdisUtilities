...
# Get-StringHash
```
Get-StringHash [-InputString] <String> [[-Algorithm] <String>] [<CommonParameters>]
```
## Synopsis
Hashes a string.
## Description
...
## Description
Uses Get-Command to determine the path to an executable, then passes the path to Split-Path to get theparent folder. Finally, opens the parent folder by passing the path as an argument to explorer.exe.
## Parameters
### -Command
